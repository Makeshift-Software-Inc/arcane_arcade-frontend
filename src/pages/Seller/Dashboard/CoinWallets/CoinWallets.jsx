...
const CoinWallets = ({ close }) => {
  ...
  const save = async (e) => {
    ...
    if (validate()) {
      ...
      destinationAddresses.BTC = destination_addresses.BTC
                                && destination_addresses.BTC.trim().length > 0
        ? destination_addresses.BTC
        : null;
      destinationAddresses.XMR = destination_addresses.XMR
                                && destination_addresses.XMR.trim().length > 0
